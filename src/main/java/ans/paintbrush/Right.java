...
//    private Color Color;
    ...
    public String toSVG() {
     ...
     public static Shape loadSVG(org.w3c.dom.Node node){
        ...
        right.getP1().x = Integer.parseInt(values[8]);
        right.getP1().y = Integer.parseInt(values[3]);
        right.getP2().x = Integer.parseInt(values[0]);
        right.getP2().y = Integer.parseInt(values[13]);
        right.setDrawColor(Color.decode(stroke.getNodeValue()));
        return right;
    }
}
